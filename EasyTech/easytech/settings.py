"""
Django settings for EasyTech project.
"""
...
# ADVERTENCIA DE SEGURIDAD: mantener la clave secreta en secreto en producción!
SECRET_KEY = 'django-insecure-your-secret-key-here-change-in-production'

# ADVERTENCIA DE SEGURIDAD: no ejecutar con debug activado en producción!
DEBUG = True

ALLOWED_HOSTS = ['.vercel.app', 'easytech.ar', 'www.easytech.ar', '.now.sh']
...
INSTALLED_APPS = [
    ...
    'web',  # Nuestra aplicación principal
]
...
WSGI_APPLICATION = 'easytech.wsgi.application'
